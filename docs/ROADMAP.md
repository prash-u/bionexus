...
## Phase 0: Architecture and Ontology
...
Connect local visual input concepts for educational tremor and movement demonstrations.

## Phase 5: Connect BioBody Insights Whole-Body Atlas Concepts

Extend body-scale ontology and visual exploration.

## Phase 6: User-Authored Biological Reasoning Maps

Allow users to compose local biological maps without accounts or remote persistence.

## Phase 7: Educator/Research/Investor Export Modes

Broaden report outputs and presentation-ready export flows.
